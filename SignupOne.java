...
import java.awt.event.*;
 ...
 public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne() {
        ...
        JLabel dob = new JLabel(" Date Of Births:");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            if (name.equals("")) {
                ...
                Conn c= new Conn();
                String query = "insert into signup value('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+email+"','"+address+"','"+marital+"','"+city+"','"+state+"','"+pincode+"')";
